...
class Container_3223dfc024 extends _PHPStan_b3f880679\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0474(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_3223dfc024 $container)
			{
	...
	public function createServiceContainer(): Container_3223dfc024
	{
		return $this;
	}
